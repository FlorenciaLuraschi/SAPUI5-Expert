sap.ui.define([
    ...
    /**
         * 
         * @param {typeof sap.core.util.MockServer} MockServer
            ...
            init: function (oOptionParameter) {
                ...
                return new Promise(function (fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function () {
                        ...
                        //configure mock server with the given options or a defaul delay of 0.5s
                        MockServer.config({
                            autoRespond: true,
                    ...
                    oManifestModel.attachRequestFailed(function () {
                       var sError = "Failed to load the applocation manifest";
